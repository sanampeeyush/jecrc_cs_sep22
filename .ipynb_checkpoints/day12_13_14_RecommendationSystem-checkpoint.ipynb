 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "c87dc85b-906d-462a-bc78-ea339917c5bf",
   "metadata": {},
   "outputs": [],
   "source": [
    "import pandas as pd"
  ...
  },
  {
   ...
   "id": "b578f389-52d8-4c74-b58a-e848b6f7feab",
   "metadata": {},
   "outputs": [],
   "source": [
    "Data Analysis\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 9,
   "id": "b513ee80-6219-499f-acdf-4e4bd08c83c0",
   "metadata": {},
   "outputs": [],
   "source": [
    "# The column names\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 10,
   "id": "fec45f6a-25b7-4df8-ba5a-7f2391b0a4a1",
   "metadata": {},
   "outputs": [],
   "source": [
    "# Read the File\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 27,
   "id": "44bfa1fb-506c-4e74-ad13-49af78bcc155",
   "metadata": {
    "jupyter": {
     "source_hidden": true
    },
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 28,
   "id": "d8bc3806-83a7-4513-9cf4-0bc7fcaad97f",
   "metadata": {
    "collapsed": true,
    "jupyter": {
     "outputs_hidden": true,
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 29,
   "id": "a10029e6-7cd1-4ba4-bc9c-866523aebb88",
   "metadata": {
    "collapsed": true,
    "jupyter": {
     "outputs_hidden": true,
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "d8fd7468-7257-4162-b087-c18458841392",
   "metadata": {
    "jupyter": {
     "source_hidden": true
    },
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "e27e6563-93a3-4a31-83a9-a64dd970a705",
   "metadata": {
    "jupyter": {
     "source_hidden": true
    },
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 33,
   "id": "9c9235fc-f6dd-49c0-914d-d02b08e3326e",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 38,
   "id": "22daac68-31c4-43bf-9ae9-9c0877280a26",
   "metadata": {},
   "outputs": [],
   "source": [
    "# Read the other file\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 39,
   "id": "dc4d17ff-3e91-4835-9197-c213093392c6",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  {
   "cell_type": "markdown",
   "id": "6328644d-e7f4-4c89-b59f-92eda1d846cf",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 11,
   "id": "d19f1baa-b209-4ebf-a29a-847b1d5cc501",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "28578       45        50       5  881007272\n",
       "66787      663        89       4  889493818\n",
       "13136      342       523       4  875319854\n",
       "48093      737       186       5  884314944\n",
       "9697       119       742       5  874775406"
      ]
     },
     "execution_count": 11,
     "metadata": {},
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 40,
   "id": "3692475a-b3b5-489b-8eda-78c0816203da",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "807        808       Program, The (1993)\n",
       "1444      1445  Ladybird Ladybird (1994)"
      ]
     },
     "execution_count": 40,
     "metadata": {},
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 12,
   "id": "569eafa5-8663-45e5-9159-34183ad12381",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 14,
   "id": "70106612-b302-4bfe-942d-2f6aa2663fd6",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  {
   "cell_type": "raw",
   "id": "77da4d88-2c9c-413b-9843-f378cda8e941",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 15,
   "id": "a86af01d-28df-41ee-9422-e21dddd2ff7d",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 16,
   "id": "bc409a86-043c-4abf-a5c3-d020f6b4f92d",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 17,
   "id": "c40b71aa-acd8-4d8f-ba68-4889a81bed21",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 18,
   "id": "cbfc4d1c-ff03-4d44-9de9-b910a7e41339",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 19,
   "id": "01fbef66-0c44-42d9-aad5-3b79c6dfa1bb",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 41,
   "id": "21ccadd6-0d15-45dd-aa2e-c220bec799d7",
   "metadata": {},
   "outputs": [],
   "source": [
    "# Merging DataFrames"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 42,
   "id": "57e3bc4f-e216-4172-888a-a417e5abd2a6",
   "metadata": {
    "collapsed": true,
    "jupyter": {
     "outputs_hidden": true
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 43,
   "id": "384a0b3e-7e5c-4b44-98c3-d13f882b3d1d",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 44,
   "id": "c9a59438-f5d8-45b8-8545-a7291effb099",
   "metadata": {
    "collapsed": true,
    "jupyter": {
     "outputs_hidden": true
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 45,
   "id": "5447e89a-eb99-49df-bfe6-ed268511a23e",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 48,
   "id": "b7b98308-a68d-4861-9100-06a0c393fc5e",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 50,
   "id": "fa2c1bc6-0dcd-4bc4-8bc8-e1b55a6efc3b",
   "metadata": {
    "tags": []
   },
   "outputs": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 56,
   "id": "40ca5fa4-b549-469e-a776-1bb9a7a382d9",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 57,
   "id": "2e1871ba-5c13-441d-988d-4c16d8ab67e1",
   "metadata": {
    "collapsed": true,
    "jupyter": {
     "outputs_hidden": true
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 59,
   "id": "1f1f23c9-3349-4890-a0ea-b8a8ff98c291",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 55,
   "id": "846403a2-9b94-4745-acb2-63b54ff06c94",
   "metadata": {
    "collapsed": true,
    "jupyter": {
     "outputs_hidden": true
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 60,
   "id": "ed0a2034-5054-45a0-ad5d-e9a907a4181a",
   "metadata": {
    "collapsed": true,
    "jupyter": {
     "outputs_hidden": true
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 61,
   "id": "ab200169-dc94-4e82-96c5-caad1a20df41",
   "metadata": {
    "collapsed": true,
    "jupyter": {
     "outputs_hidden": true
  ...
  {
   "cell_type": "markdown",
   "id": "2e889952-dcb4-4539-a3f2-22c96a38751d",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 63,
   "id": "8906392f-10c7-40d4-99a2-5f19b7111177",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 64,
   "id": "09887655-31da-463e-ba62-8a1cdd0edd4e",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 68,
   "id": "ceb478da-7e44-4a6b-ba0d-76b6174b6f35",
   "metadata": {},
   "outputs": [],
   "source": [
    "import warnings\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 72,
   "id": "cbb48dd9-ede6-4e0b-9c54-ea06a5a5157a",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 78,
   "id": "5bfbe6f5-4301-4f30-bdcd-77e0534b321d",
   "metadata": {
    "collapsed": true,
    "jupyter": {
     "outputs_hidden": true
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 86,
   "id": "d760f2c3-a8af-4a3b-af10-141336669e67",
   "metadata": {
    "collapsed": true,
    "jupyter": {
     "outputs_hidden": true
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 87,
   "id": "30377e7f-029c-4f21-9489-fafe1bc6b989",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 88,
   "id": "9405e714-3ff8-4999-8f32-41cad8b7da29",
   "metadata": {
    "collapsed": true,
    "jupyter": {
     "outputs_hidden": true,
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 90,
   "id": "b95961ef-f623-4888-86db-8e4d66672a0c",
   "metadata": {
    "tags": []
   },
   "outputs": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 99,
   "id": "4fd4a19a-2cc5-418b-9848-19be7fcd033a",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 100,
   "id": "a7bd7573-f08a-4194-990e-adb2550e07a8",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 101,
   "id": "7adf47b8-803f-4d05-ac38-b44f24494f60",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 102,
   "id": "48b67ee1-f84a-4a95-9503-ba69e3d18c55",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 104,
   "id": "a0f7c0e9-3fec-44cb-8b51-052eb158f295",
   "metadata": {},
   "outputs": [],
   "source": [
    "import pandas as pd\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 106,
   "id": "e17649f5-34ac-4ba6-8c9a-ebff18f7fc37",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "3ce29bc2-0f40-46fa-b6f6-de7c868b4e79",
   "metadata": {},
   "outputs": [],
   "source": []
  }
